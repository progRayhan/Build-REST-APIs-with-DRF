...
from watchlist_app.api.views import ReviewDetail, StreamPlatformAV, StreamPlatformDetailsAV, WatchListAV, WatchListDetailAV, ReviewList
...
urlpatterns = [
    ...
    path('stream/<int:pk>/review', StreamPlatformDetailsAV.as_view(), name="streamplatform-detail"),
